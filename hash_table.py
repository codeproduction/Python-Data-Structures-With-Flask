...
class HashTable: 
    def __init__(self, table_size):
        ...
        self.hash_table = [None] * table_size # creates a list of Nones of table_size

    def custom_hash(self, key):
        hash_value = 0
        for i in key:
            hash_value += ord(i)
            hash_value = (hash_value * ord(i)) % self.table_size # MOD will help keep hash val within table_size
        return hash_value
